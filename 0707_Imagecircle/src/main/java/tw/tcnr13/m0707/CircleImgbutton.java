...
public class CircleImgbutton extends AppCompatImageButton {
    ...
    public CircleImgbutton(@NonNull Context context) {
        super(context);
    }

    public CircleImgbutton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleImgbutton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
